...
def compute_average_flops_cost(self):
    ...
    for module in self.modules():
        if is_supported_instance(module):
            ...
            # print(str(module) + " :  "  + str(module.__flops__ / 10**6) + "\t total: " + str(flops_sum/10**6) )
...
def conv_flops_counter_hook(conv_module, input, output):
    ...
    conv_per_position_flops =2*kernel_height * kernel_width * in_channels * filters_per_channel
    ...
    # print(str(conv_module) + str(overall_conv_flops))
