...
from model.layers.basic import _ConvBNReLU, InvertedResidual
from torch.quantization import QuantStub, DeQuantStub
__all__ = ['MobileNetV2', 'get_mobilenet_v2', 'mobilenet_v2_1_0',
           'mobilenet_v2_0_75', 'mobilenet_v2_0_5', 'mobilenet_v2_0_35']


class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0, dilated=False, 
...
def mobilenet_v2_0_35(**kwargs):
    return get_mobilenet_v2(0.35, **kwargs)
