...
class ConvBNReLU(nn.Module):
    ...
    def __init__(self, nIn, nOut,  norm_layer, kernel_size, padding=0, stride=1):
        '''
...
class ConvBN(nn.Module):
    ...
    def __init__(self, nIn, nOut, norm_layer, kernel_size, padding=0, stride=1):
        ...
        super().__init__()
        self.norm_layer = norm_layer
        if norm_layer == 'none' or norm_layer == 'instance':
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        for i in range(n_downsampling):  # add upsampling layers
            ...
            model += [nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
                      ConvBNReLU(ngf * mult, int(ngf * mult / 2),norm_layer=norm_layer,
...
class ResnetBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.skip_add.add(x, self.conv_block(x))  # add skip connections
        return out
